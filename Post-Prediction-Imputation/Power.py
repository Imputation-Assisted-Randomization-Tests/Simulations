...
if __name__ == '__main__':
    ...
    for coef in np.arange(0.0,1.2,0.2):
        ...
        if beta_coef_rounded in beta_to_lambda:
            ...
            run(50, Single = 1, filepath = "Result/HPC_power_50_unobserved_interference_adjusted_3" + "_single", adjust = 3, strata_size = S_size,  Missing_lambda = lambda_value,small_size=True)
        else:
            print(f"No lambda value found for beta_coef: {beta_coef_rounded}")
